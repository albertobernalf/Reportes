...
class nuevoPdfView(TemplateView):
    ...
    def cabezote(self, doc, y, Story, tipodoc, documento, folio,   headline_mayor, headline_mayor1, headline_mayor2 ,headline_mayor3, headline_mayor33, headline_mayor4,  subtitle_tipoevol,subtitle_atencion,subtitle_cabezote,subtitle_nacimiento,lineas):
            ...
            if (localcabezote + lineas) < 60 and localcabezote != 0:
                localcabezote = localcabezote + lineas
            ...
            #i_tbl = Table([[imagen], [Paragraph("FUNDACION HOSPITAL SAN CARLOS",headline_mayor3)]])
            #tbl = Table(i_tbl, colWidths=[19 * cm])
            ...
            tbl = Table(tbl_data, colWidths=[19 * cm])
            ...
            tbl_data = [
                [
                 ...
                 Paragraph("Fecha:", headline_mayor3),Paragraph(str(fecha), headline_mayor),
                 ],
            ]

            tbl = Table(tbl_data, colWidths=[13 * cm, 3 * cm, 3 * cm])
            ...
            for row in rows:
                ...
                tbl_data1 = [
                    [Paragraph(str(texto), headline_mayor),Paragraph(str(tipodoc), headline_mayor),
                     Paragraph(str(documento), headline_mayor),Paragraph(str(row.PACIENTE), headline_mayor),
                     Paragraph("", headline_mayor)
                   ],
                ]

                tbl1 = Table(tbl_data1, colWidths=[4.5 * cm, 2 * cm , 3 * cm ,9 * cm, 0.5 * cm])
                ...
                tbl_data2 = [
                    [
                     ...
                     Paragraph("Fecha Nac:", headline_mayor4), Paragraph(str(row.FECHA_NACIMIENTO), subtitle_nacimiento),   Paragraph("Edad Actual:", headline_mayor4), Paragraph(str(row.EDAD_ACTUAL), subtitle_nacimiento),
                ...
                tbl2 = Table(tbl_data2, colWidths=[2.4 * cm, 1.8 * cm, 2.5 * cm, 1.9 * cm, 1.3 * cm, 1.7 * cm, 3.2 * cm, 0.5 * cm, 2.5 * cm, 2 * cm, 0.5 * cm])
                ...
                tbl = Table(tbl_data, colWidths=[3 * cm, 5 * cm, 3 * cm, 2 * cm, 3 * cm, 2 * cm,1 * cm])
                ...
                tbl_data = [
                    [Paragraph("Acompanante:", headline_mayor), Paragraph(str(row.ACOMPANANTE), subtitle_cabezote),
                     ...
                     Paragraph("", headline_mayor),Paragraph("", headline_mayor),Paragraph("", headline_mayor),
                    ],
                ]
    ...
    def post(self, request, *args, **kwargs):
        ...
        for rowGlobal in rowsGlobal:
            ...
            lineas = 1
            localppal = self.cabezote(doc, comienzaFolio, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4, subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento,lineas)
            texto1 = '_______________________________________________________________________________________________'
            Story.append(Paragraph(texto1, headline_mayor))
            ...
            lineas = 1
            localppal = self.cabezote(doc, localppal, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,  subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento,       lineas)
            Story.append(tbl)
            lineas = 1
            localppal = self.cabezote(doc, localppal, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,  subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento,lineas)
            ...
            lineas = 1
            localppal = self.cabezote(doc, localppal, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1, headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,
                                      subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento, lineas)
    ...
    def triage(self, doc, y, Story, tipodoc, documento, folio,   headline_mayor, headline_mayor1, headline_mayor2 ,headline_mayor3, headline_mayor33, headline_mayor4,subtitle_tipoevol,subtitle_atencion,subtitle_cabezote,subtitle_nacimiento):
        ...
        if rows == []:
            ...
            for row in rows:
                ...
                lineas = int(len(str(row.OBSERVACIONES)) / 140) + int(str(row.OBSERVACIONES).count("\n"))
                localTriage = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,
                                            headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,
                                            subtitle_tipoevol, subtitle_atencion, subtitle_cabezote,
                                            subtitle_nacimiento, lineas)
            ...
            for row in rows:
                ...
                if row.RUTA_FIRMA != ' ':
                    ...
                    if os.path.isfile(row.RUTA_FIRMA) == True:
                         ...
                         imagen1.hAlign = 'LEFT'
                         lineas = 5
                         localRegistro = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor,
                                                       headline_mayor1,
                                                       headline_mayor2, headline_mayor3, headline_mayor33,
                                                       headline_mayor4,
                                                       subtitle_tipoevol, subtitle_atencion, subtitle_cabezote,
                ...
                lineas = int(len(str(row.MEDICO)) / 140) + int(str(row.MEDICO).count("\n"))
                ...
                localRegistro = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,
                                              ...
                                              subtitle_nacimiento, lineas)
                Story.append(Spacer(1, 3))
                lineas = int(len(str(row.REGISTRO)) / 140) + int(str(row.REGISTRO).count("\n"))
                ...
                localRegistro = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,
                                              ...
                                              subtitle_nacimiento, lineas)
                Story.append(Spacer(1, 3))
                lineas = int(len(str(row.ESPECIALIDAD)) / 140) + int(str(row.ESPECIALIDAD).count("\n"))
        ...
        if rows == []:
            ...
            for row in rows:
                ...
                if imprimioEnf == 'No' and row.ENFERMEDAD_ACTUAL != '':
                    ...
                    lineas =1
                    localEvoluciones = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor,
                                                  headline_mayor1,
                                                  headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,
                                                  subtitle_tipoevol, subtitle_atencion, subtitle_cabezote,
                                                  subtitle_nacimiento, lineas)
                    ...
                    lineas = int(len(str(row.ENFERMEDAD_ACTUAL)) / 140) + int(str(row.ENFERMEDAD_ACTUAL).count("\n"))
                ...
                lineas = int(len(str(row.TIPO)) / 140) + int(str(row.TIPO).count("\n"))
    ...
    def notasEnf(self,  doc, y, Story, tipodoc, documento, folio,   headline_mayor, headline_mayor1, headline_mayor2 ,headline_mayor3, headline_mayor33, headline_mayor4, subtitle_tipoevol,subtitle_atencion,subtitle_cabezote,subtitle_nacimiento):
        ...
        if rowsEnf == []:
            ...
            for rowEnf in rowsEnf:
                ...
                Story.append(Spacer(1, 4))
                lineas = int(len(str(rowEnf.EVOLUCION))/140) + int(str(rowEnf.EVOLUCION).count("\n"))
        ...
        if rowsNoQx == []:
            ...
            for rowNoQx in rowsNoQx:
                ...
                recibo = self.cabezote(doc, localprocNoQx, Story, tipodoc, documento, folio, headline_mayor,     headline_mayor1, headline_mayor2, headline_mayor3, headline_mayor33,
                                       headline_mayor4, subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento,0)
                localprocNoQx = recibo
        con11.close()
    ...
    def interconsultas(self, doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1, headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4, subtitle_tipoevol, subtitle_atencion,subtitle_cabezote, subtitle_nacimiento):
        ...
        localInterconsulta = self.cabezote(doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1,
                                    headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,
                                    subtitle_tipoevol, subtitle_atencion, subtitle_cabezote, subtitle_nacimiento,0)
    ...
    def QxCancela(self, doc, y, Story, tipodoc, documento, folio, headline_mayor, headline_mayor1, headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4, subtitle_tipoevol, subtitle_atencion,   subtitle_cabezote, subtitle_nacimiento):
        ...
        localQxCan = self.cabezote(doc, localQxCan, Story, tipodoc, documento, folio, headline_mayor,
                                   headline_mayor1,
                                   headline_mayor2, headline_mayor3, headline_mayor33, headline_mayor4,
                                   subtitle_tipoevol, subtitle_atencion, subtitle_cabezote,
                                   subtitle_nacimiento,0)
        ...
        if rowsQxCan == []:
            ...
            recibo = self.cabezote(doc, localQxCan, Story, tipodoc, documento, folio, headline_mayor,
                                   headline_mayor1, headline_mayor2, headline_mayor3, headline_mayor33,
                                   headline_mayor4, subtitle_tipoevol, subtitle_atencion, subtitle_cabezote,
                                   subtitle_nacimiento,0)
            localQxCan = recibo
