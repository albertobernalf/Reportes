...
class nuevoPdfView(TemplateView):
    ...
    def cabezote(self, doc, y, Story, tipodoc, documento, folio,   headline_mayor, headline_mayor1, headline_mayor2 ,headline_mayor3, headline_mayor33, headline_mayor4,  subtitle_tipoevol,subtitle_atencion,subtitle_cabezote,subtitle_nacimiento):
        ...
        for row in rows:
            ...
            tbl2 = Table(tbl_data2, colWidths=[3.5 * cm, 1.8 * cm, 1.5 * cm, 1.5 * cm, 1.5 * cm, 1.7 * cm, 3.5 * cm, 0.5 * cm, 1.5 * cm, 1.8 * cm, 0.5 * cm])
        ...
        if rowsTerCan == []:
            ...
            for rowTerCan in rowsTerCan:
                ...
                if rx == '' or rx1 != rx:
                    ...
                    tbl_data = [[Paragraph(str(rowTerCan.OBSERVACIONES), subtitle_atencion),
                                 Paragraph("", headline_mayor2), ]]
        ...
        if rowsQxCan == []:
            ...
            for rowQxCan in rowsQxCan:
                ...
                if rx == '' or rx1 != rx:
                    ...
                    tbl_data = [[Paragraph(str(rowQxCan.OBSERVACIONES), subtitle_atencion),
                                 Paragraph("", headline_mayor2), ]]
